			...
			print '
			  ...
			  <form class="form-horizontal" action="" name="imdbsearch" method="POST">
				<div class="form-group">
				  ...
				  <div class="col-sm-10">
					<input type="text" class="form-control" id="title" placeholder="Unesite naslov filma" name="title" required>
				  </div>
				</div>
				<div class="form-group">
				  <label class="control-label col-sm-2" for="year">Godina</label>
				  <div class="col-sm-10">          
					<input type="year" class="form-control" id="year" placeholder="Unesite godinu filma" name="year" pattern="[0-9]{4}">
				  </div>
				</div>
